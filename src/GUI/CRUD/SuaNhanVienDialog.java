...
public class SuaNhanVienDialog extends javax.swing.JDialog {
     ...
     */
    public SuaNhanVienDialog(java.awt.Frame parent, boolean modal, DTO_NhanVien nvDTO, GUI.Menu.NhanVien ap) {
        super(parent, modal);
        this.ap = ap;
        initComponents();
        this.nvDTO = nvDTO;
        ...
        jDateChooser1.setDate(nvDTO.getNgaysinh());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (ngaysinh == null) {
            JOptionPane.showMessageDialog(null, "Vui lòng chọn ngày sinh dung dinh dang dd/MM/yyyy");
            return;
        }
         SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
        ...
        DTO_NhanVien nv = new DTO_NhanVien(nvDTO.getManv(), ten, gioitinh, new java.sql.Date(ngaysinh.getTime()), sdt, email, 1);
