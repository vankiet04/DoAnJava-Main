 ...
 * @author Kiet
 */
public class XemNhomQuyen extends javax.swing.JDialog {
    ...
    public XemNhomQuyen(java.awt.Frame parent, boolean modal, int id) {
        super(parent, modal);
        this.manhomquyen = id;
        initComponents();
        loadNhomquyen();
        jTextField1.setText(busNhomQuyen.getNhomQuyen(id).getTennhomquyen());
    ...
    public void loadNhomquyen() {
        ...
        for (ArrayList<JCheckBox> temp : listCheckBox) {
            for (JCheckBox jCheckBox : temp) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(XemNhomQuyen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
