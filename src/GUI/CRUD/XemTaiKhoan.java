 ...
 * @author Kiet
 */
public class XemTaiKhoan extends javax.swing.JDialog {
    ...
    int manv;
    public XemTaiKhoan(java.awt.Frame parent, boolean modal, int manv) {
        super(parent, modal);
        this.manv = manv;
        initComponents();
    ...
    public void loadcomboboxnhomquyen() {
        ...
        for (DTO_TaiKhoan x : listtk) {
            if (x.getManv() == manv) {
                for (DTO_NhomQuyen y : busNhomQuyen.getAllData()) {
                    if (y.getManhomquyen() == x.getManhomquyen()) {
                        jComboBox2.addItem(y.getTennhomquyen());
                    }
                }
            }
        }
