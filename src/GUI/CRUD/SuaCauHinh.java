...
public class SuaCauHinh extends javax.swing.JDialog {
    ...
    private void jButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MousePressed
        //Sua cau hinh
        DTO_ChiTietCauHinh dto = new DTO_ChiTietCauHinh();

        // nếu thông tin lúc ban đầu giống thông tin lúc sau vừa sửa thì thông báo không có thông tin nào thay đổi
   
        dto.setMaphienbansp(Integer.parseInt(idsp));
        dto.setRam(Integer.parseInt(jComboBox2.getSelectedItem().toString().split(" ")[0]));
        dto.setRom(Integer.parseInt(jComboBox1.getSelectedItem().toString().split(" ")[0]));
        dto.setGianhap(0);
        dto.setGiaxuat(0);
        dto.setSoluongton(Integer.parseInt(jTextField5.getText()));
       
        int result = ctch.update(dto);
        // nếu chưa có thông tin nào thay đổi thì thông báo vui lòng nhập thông tin cần thay đổi
