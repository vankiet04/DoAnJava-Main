...
public class QuanLyHDH extends javax.swing.JDialog {
    ...
    DTO_TaiKhoan user;
     ...
     public QuanLyHDH(java.awt.Frame parent, boolean modal, GUI.MainProgram main, DTO_TaiKhoan user) {
         super(parent, modal);
         this.main = main;
         this.user = user;
         initComponents();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("QUẢN LÝ HỆ ĐIỀU HÀNH");
    ...
    private void jPanel3MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel3MousePressed
        ...
        if (currentIDselected.equals("-1")) {
            JOptionPane.showMessageDialog(this, "Vui lòng chọn HDH can sua");
            return;
        }
       SuaHDH suaThuongHieu = new SuaHDH(parent, true, currentIDselected, this);
    ...
    private void jPanel4MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel4MousePressed
        // xoa thuong hieu
        if (currentIDselected.equals("-1")) {
            JOptionPane.showMessageDialog(this, "Vui lòng chọn HDH cần xóa");
            return;
        }
        int dialogButton = JOptionPane.YES_NO_OPTION;
        int dialogResult = JOptionPane.showConfirmDialog(this, "Bạn có chắc chắn muốn xóa HDH này không?",
                "Xác nhận xóa", dialogButton);
        if (dialogResult == 0) {
            int result = bus.deleteTH(currentIDselected);
            if (result == 1) {
